...
Usage: `/c4-checklist [system-id]`

- `system-id` - System ID to check (default: auto-detected from codemap/)
...
```
Phase 1: Preparation --> Phase 2: Parallel Checklist Verification --> Phase 3: Synthesis --> Phase 4: Write Report
```

Phase 2 verifies three checklist categories in parallel: General, Elements, and Relationships.
