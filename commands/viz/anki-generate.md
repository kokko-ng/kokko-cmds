...
This command uses **parallel analysis with synthesis** - independent content extraction runs in parallel, then a synthesis phase consolidates and deduplicates cards:
...
│   External    │       │  & Technology │       │   & Code      │
│   Systems     │       │    Stack      │       │   Patterns    │
└───────┬───────┘       └───────┬───────┘       └───────┬───────┘
        │                         │                         │
        └─────────────────────────┼─────────────────────────┘
                                  │
                                  ▼
                    ┌───────────────────────────────────────┐
                    │   Phase 2: Synthesis & Deduplication  │
