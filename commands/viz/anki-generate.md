...
Usage: `/anki-generate [system-id]`

- `system-id` - System ID to generate cards for (default: auto-detected from codemap/)

If `$ARGUMENTS` is provided, use it as the system-id.
