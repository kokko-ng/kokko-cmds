...
2. **Read reference file**: Load `references/<lang>-deadcode.md` for tool-specific instructions
...
7. **Commit each removal separately**: Use message format `chore(cleanup): remove unused <item>`
